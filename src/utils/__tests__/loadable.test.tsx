...
const LazyComponenWithDefaultExport = lazyLoad(() => import('./loadable.mock'));

const LazyComponentWithExportedFunction = lazyLoad(
  () => import('./loadable.mock'),
  (module) => module.LoadableMock,
);

const LazyComponentWithFallback = lazyLoad(() => import('./loadable.mock'), undefined, {
